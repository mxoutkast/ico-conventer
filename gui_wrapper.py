...
class IcoConverterGUI:
    ...
    def _setup_ui(self) -> None:
        ...
        # Bind keyboard shortcuts for the file list
    ...
    def _select_all_files(self, event: tk.Event | None = None) -> str | None:
        ...
        Args:
            event: The optional Tkinter event that triggered this

        Returns:
            'break' if triggered by event to prevent default propagation
        """
