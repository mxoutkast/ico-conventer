...
class IcoConverterGUI:
    ...
    def _setup_ui(self) -> None:
        ...
        self.file_list.bind('<Delete>', lambda e: self._remove_selected_files())
        self.file_list.bind('<BackSpace>', lambda e: self._remove_selected_files())
        # Windows/Linux Select All
        self.file_list.bind('<Control-a>', lambda e: self._select_all_files())
        # macOS Select All
        if sys.platform == 'darwin':
            self.file_list.bind('<Command-a>', lambda e: self._select_all_files())
    ...
    def _select_all_files(self) -> str:
