...
def test_file_list_component():
    ...
    try:
        ...
        with open('gui_wrapper.py', 'r') as f:
            ...
            # Check for file list creation with correct columns
            ...
            assert "Remove Selected (Del)" in content, "Remove button not found with shortcut hint"
            print("  ✓ Remove Selected (Del) button exists")
